    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('startDemoBtn')?.addEventListener('click', () => {
                alert('Demo functionality coming soon! This will show an interactive analysis of a sample resume.');
            });
            ...
            document.getElementById('analyzeSkillsBtn')?.addEventListener('click', () => {
                alert('Skills analysis functionality coming soon!');
            });

            console.log('Clearsight IP website loaded successfully!');
        });
    </script>
</body>
</html>`;